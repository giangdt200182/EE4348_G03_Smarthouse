...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_subscribe(client, "/test_mqtt_kiet_giang/qos2", 1);
        ESP_LOGI(TAG, "sent subscribe successful, msg_id=%d", msg_id);
        break;
    ...
    case MQTT_EVENT_DATA:
        ...
        char *endptr;
        long integerValue;
        integerValue = strtol(event->data, &endptr, 10);
        ESP_LOGI(TAG,"asdasa=%d", integerValue);
...
void Publisher_Task(void *params)
{
    while (1)
    {
        ...
        {
            msg_id = esp_mqtt_client_publish(client, "/test_mqtt_kiet_giang/qos0", str, 0, 1, 0);
            ESP_LOGI(TAG, "sent publish successful, msg_id=%d", msg_id);
        }
        else
        {
...
static void mqtt_app_start(void)
{
    ...
    esp_mqtt_client_config_t mqttConfig = {
        ...
        // .broker.address.uri = "mqtt://192.168.243.214:1883",
    };
